    ...
    public void run() {
        ...
        if (eti.getLocation().x >= p.getlbl_barrera().getLocation().x - 10) {
            if (c1 > c2 && c1 > c3 && c1 > c4) {
                JOptionPane.showMessageDialog(null, "Ganó rojo");
            } else if (c2 > c1 && c2 > c3 && c2 > c4) {
                JOptionPane.showMessageDialog(null, "Ganó blanco");
            } else if (c3 > c1 && c3 > c2 && c3 > c4) {
                JOptionPane.showMessageDialog(null, "Ganó amarillo");
            } else if(c4 > c1 && c4 > c2 && c4>c3){
                JOptionPane.showMessageDialog(null, "Ganó rosado");
            }
            else {
