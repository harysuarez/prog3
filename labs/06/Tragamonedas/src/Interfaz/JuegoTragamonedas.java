...
boolean respuesta3 = false;
    ...
    private void IniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IniciarActionPerformed
     ...
     imag1 = new Ima1(tiempoMilisegundos, this);
     imag2 = new Ima2(tiempoMilisegundos, this);
     imag3 = new Ima3(tiempoMilisegundos, this);
     respuesta1 = false;
     respuesta2 = false;
     respuesta3 = false;
   ...
   private void comprobarResultado() {
        if (respuesta1 && respuesta2 && respuesta3) {
            ...
            if (imagen1.getIcon().toString().equals(imagen2.getIcon().toString()) && imagen1.getIcon().toString().equals(imagen3.getIcon().toString())) {
